...
namespace DatabaseWrapper
{
    ...
    {
        public static readonly string CONN_STR = Database.ConnectionString;
        public static string MonitorDB
        {
            get
            {
                return Database.MonitorDB;
            }
        }
        ...
        public static SqlDataReader ExecuteReader(CommandType cmdType, string cmdText, params SqlParameter[] cmdParms)
        {
            ...
            {
                cmdText = GrayReleaseManager.GetGrayReleaseSql(cmdText);
            }
        ...
        private static void PrepareCommand(SqlCommand command, SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, SqlParameter[] commandParameters, out bool mustCloseConnection)
        {
            ...
            {
                // 灰度发布
                commandText = GrayReleaseManager.GetGrayReleaseSql(commandText);
            }
        ...
        public static int ExecuteNonQuery(string connectionString, string spName, params object[] parameterValues)
        {
            ...
            // 灰度发布
            spName = GrayReleaseManager.GetGrayReleaseSql(spName);
        ...
        {
            string timeoutString = ConfigurationManager.AppSettings["DatabaseCommandTimeoutSeconds"];
            int timeout;
            ...
            // default to 120 seconds (2 minutes) if the setting is not available.
            return 120;
        }
        public static string ExecuteString(string connectionString, CommandType commandType, string commandText)
        {
            return ExecuteString(connectionString, commandType, commandText, null);
        }
        public static string ExecuteString(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            if (commandType == CommandType.StoredProcedure)
            {
                commandText = GrayReleaseManager.GetGrayReleaseSql(commandText);
        ...
        /// <returns></returns>
        public static string ExecuteString2(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            if (commandType == CommandType.StoredProcedure)
            {
                commandText = GrayReleaseManager.GetGrayReleaseSql(commandText);
        ...
        public static string ExecuteStringForReturn(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            if (commandType == CommandType.StoredProcedure)
            {
                commandText = GrayReleaseManager.GetGrayReleaseSql(commandText);
        ...
        {
            FillDataset(CONN_STR, CommandType.Text, commandText, dataSet, tableNames, null);
        }
        public static void FillDataset(string commandText, CommandType commandType, DataSet dataSet, string[] tableNames)
        {
            FillDataset(CONN_STR, commandType, commandText, dataSet, tableNames, null);
        }
        public static void FillDataset(string commandText, CommandType commandType, DataSet dataSet, string[] tableNames, params SqlParameter[] commandParameters)
        {
            FillDataset(CONN_STR, commandType, commandText, dataSet, tableNames, commandParameters);
        }
                ...
                try
                {
                    ...
                    for (int n = 0; n < SQLStringList.Count; n++)
                    {
                        ...
                        if (strsql.Trim().Length > 1)
                        {
                            ...
                            //cmd.Parameters.Add(SqlParameter Value);SqlParameter[] commandParameters
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        foreach (DictionaryEntry myDE in SQLStringList)
                        {
                            ...
                            if (myDE.Value.ToString().Length > 0)//20130116JX
                            {
        ...
        public static DataSet GetListPage(int PageSize, int PageIndex, string strWhere, string field, string tableName, string orderBy)
        {
            SqlParameter[] p = {
            ...
            FillDataset("pop_HSLTPage", CommandType.StoredProcedure, dst, new string[] { "ds" }, p);
            return dst;
