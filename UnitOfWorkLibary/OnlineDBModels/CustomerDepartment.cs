...
namespace UnitOfWorkLibary.OnlineDBModels
{
    public partial class CustomerDepartment
    {
        ...
        public string SentInvoiceName { get; set; }
        public string SentInvoicePhone { get; set; }
        public string SentInvoiceMobilePhone { get; set; }
        public string SentInvoiceFax { get; set; }
        public string SentInvoiceEmail { get; set; }
        public string SentInvoiceAddress { get; set; }
        public int? SentInvoiceAreaSysNo { get; set; }
        public string SentInvoiceZip { get; set; }
        public int DisPatchType { get; set; }
        public string DisPatchDayIndex { get; set; }
    }
}
